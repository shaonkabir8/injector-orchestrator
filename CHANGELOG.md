...
- `bin/hydra`: Enhanced Hydra-Agent v1.0.0 Rust release binary with colorized pixel-perfect ANSI UI, shell script critic inference, dynamic model fallback for `run`, and auto-port selection for `serve`.
